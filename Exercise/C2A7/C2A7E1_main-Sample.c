...
int main(int argc, char *argv[])
{
   ...
   //
   // The following loop will read one string at a time from stdin until EOF
   // is reached.  For each string read the BuildTree function will be called
   // to update the tree.
   //
...
//
// BuildList searches bin bp of the list for a node representing the string
// in str.  If found, its string count will be incremented.  If not found,
// a new node for that string will be created, put at the top of the list,
// and its string count set to 1.
//
